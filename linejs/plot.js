...
$.ajax({
    ...
    success: function (data) {
        ...
        min = data.datasetInfo.limits.min + 12000;
        max = data.datasetInfo.limits.max + 15000;
        ...
        cumlen = data.ranked_communities.length;
        for (var ticks = 1; ticks <= cumlen; ticks++) {
            tickMarks2.push(ticks);
        }
...
nv.addGraph(function () {
    ...
    chart.yAxis
        ...
        .tickFormat(function (d) {
            if (jQuery.inArray(d, tickMarks2) !== -1)return "Community   " + d;
        });
    ...
    chart.lines.dispatch.on('elementClick', function (e) {
        var full = 1;
        if ($('#main_choice').text().substr(21) === "Users") {
            if (users[e.point.y - 1][timestamps.indexOf(e.point.x)] === 0) {
                full = 0;
            }
        }
        if ($('#main_choice').text().substr(21) === "Centrality") {
            if (centrality[e.point.y - 1][timestamps.indexOf(e.point.x)] === 0) {
                full = 0;
            }
        }
        if ($('#main_choice').text().substr(21) === "Connections") {
        ...
        if (full === 0) {
            ...
            nv.addGraph(function () {
                ...
                d3.select('#navigation_chart svg')
                ...
                setTimeout(function () {
                    ...
                    for (var j = 0; j < timelen; j++) {
                        if (text.substr(21) === "Users") {
                            ...
                            $('#navigation_chart .nv-scatterWrap .nv-groups .nv-series-0 .nv-point-' + j).attr("r", cent + 1);
                        }
                    ...
                    //}
                    $('#navigation_chart .nv-scatterWrap .nv-groups .nv-series-0 .nv-point-' + timestamps.indexOf(e.point.x)).attr("fill", "#ff0000");
                    $('#navigation_chart .nv-scatterWrap .nv-groups .nv-group circle').attr("stroke-width", "1");
                    $('#navigation_chart .nv-scatterWrap .nv-groups .nv-group circle').attr("stroke-opacity", ".3");


                    d3.select('#navigation_chart')
                        .selectAll('path.nv-line')
                        .style('opacity', 0);
                    $("#navigation_chart .nv-axisMaxMin").hide();
                }, 100);
                return chart;
            });

            $('#selection_wrapper').stop().animate({"opacity": 1});

            $('#main_chart').stop().animate({"opacity": 0}, 1000, function () {
                $('#main_chart').hide();
            });
        }
    });
    ...
    chart.lines.dispatch.on('elementMouseover', function (e) {
        ...
        if (e.point.z > 0) {
            ...
            $('.nvtooltip #words').append('<p class="categories" style="width:170px;border-bottom: 2px solid gray;">USERS - CENTRALITY RANK</p>');

            $('.nvtooltip #words').append('<div style="width:770px;border-bottom: 2px;border-bottom-color: gray;border-bottom-style: double;"><div id="hashtagsdiv" style="vertical-align: top;width:150px;padding-top: 15px;display:inline-block;"></div><div id="keywordsdiv" style="vertical-align: top;width:150px;padding-top: 15px;display:inline-block;"></div><div id="bigramsdiv" style="vertical-align: top;width:150px;padding-top: 15px;display:inline-block;"></div><div id="domainsdiv" style="vertical-align: top;width:150px;padding-top: 15px;display:inline-block;"></div><div id="ucentdiv" style="vertical-align: top;width:170px;padding-top: 15px;display:inline-block;"></div></div>');
            ...
            setTimeout(function () {
                ...
                if (!(tags[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5] === "-")) {
                    $('#hashtagsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + tags[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(tagssize[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5]) + '</p>');
                }
                if (!(tags[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1] === "-")) {
                    $('#hashtagsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + tags[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(tagssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1]) + '</p>');
                }
                if (!(tags[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2] === "-")) {
                    $('#hashtagsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + tags[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(tagssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2]) + '</p>');
                }
                if (!(tags[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3] === "-")) {
                    $('#hashtagsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + tags[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(tagssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3]) + '</p>');
                }
                if (!(tags[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4] === "-")) {
                    $('#hashtagsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + tags[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(tagssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4]) + '</p>');
                }

                if (!(keys[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5] === "-")) {
                    $('#keywordsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + keys[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(keyssize[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5]) + '</p>');
                }
                if (!(keys[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1] === "-")) {
                    $('#keywordsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + keys[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(keyssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1]) + '</p>');
                }
                if (!(keys[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2] === "-")) {
                    $('#keywordsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + keys[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(keyssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2]) + '</p>');
                }
                if (!(keys[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3] === "-")) {
                    $('#keywordsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + keys[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(keyssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3]) + '</p>');
                }
                if (!(keys[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4] === "-")) {
                    $('#keywordsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + keys[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(keyssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4]) + '</p>');
                }

                if (!(bigrams[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5] === "-")) {
                    $('#bigramsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + bigrams[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(bigramssize[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5]) + '</p>');
                }
                if (!(bigrams[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1] === "-")) {
                    $('#bigramsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + bigrams[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(bigramssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1]) + '</p>');
                }
                if (!(bigrams[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2] === "-")) {
                    $('#bigramsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + bigrams[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(bigramssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2]) + '</p>');
                }
                if (!(bigrams[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3] === "-")) {
                    $('#bigramsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + bigrams[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(bigramssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3]) + '</p>');
                }
                if (!(bigrams[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4] === "-")) {
                    $('#bigramsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + bigrams[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(bigramssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4]) + '</p>');
                }

                if (!(domains[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5] === "-")) {
                    $('#domainsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + domains[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(domainssize[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5]) + '</p>');
                }
                if (!(domains[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1] === "-")) {
                    $('#domainsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + domains[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(domainssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1]) + '</p>');
                }
                if (!(domains[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2] === "-")) {
                    $('#domainsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + domains[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(domainssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2]) + '</p>');
                }
                if (!(domains[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3] === "-")) {
                    $('#domainsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + domains[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(domainssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3]) + '</p>');
                }
                if (!(domains[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4] === "-")) {
                    $('#domainsdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 100px;word-wrap: break-word;white-space: normal;text-align: left;">' + domains[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(domainssize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4]) + '</p>');
                }

                if (!(ucent[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5] === "-")) {
                    $('#ucentdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 110px;word-wrap: break-word;white-space: normal;text-align: left;">' + ucent[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(ucentsize[e.point.y - 1][(timestamps.indexOf(e.point.x)) * 5]) + '</p>');
                }
                if (!(ucent[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1] === "-")) {
                    $('#ucentdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 110px;word-wrap: break-word;white-space: normal;text-align: left;">' + ucent[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(ucentsize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 1]) + '</p>');
                }
                if (!(ucent[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2] === "-")) {
                    $('#ucentdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 110px;word-wrap: break-word;white-space: normal;text-align: left;">' + ucent[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(ucentsize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 2]) + '</p>');
                }
                if (!(ucent[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3] === "-")) {
                    $('#ucentdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 110px;word-wrap: break-word;white-space: normal;text-align: left;">' + ucent[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(ucentsize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 3]) + '</p>');
                }
                if (!(ucent[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4] === "-")) {
                    $('#ucentdiv').append('<p style="font-size:12px;padding: 2px 10px;float: left;text-align: left;width: 110px;word-wrap: break-word;white-space: normal;text-align: left;">' + ucent[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4] + '</p><p style="padding:0;display: inline-block;float: right;top: 2px;position: relative;margin-right: 2px;">' + Math.round(ucentsize[e.point.y - 1][((timestamps.indexOf(e.point.x)) * 5) + 4]) + '</p>');
                }
            ...
            d3.select('g.nv-interactive').append("g").attr("class", " nv-wrap nv-interactiveLineLayer").append("g").attr("class", "nv-interactiveGuideLine").append("line")
                ...
                .attr("y2", 0);
            var point;
            $('#main_chart .nv-scatterWrap .nv-groups .nv-series-' + (e.point.y - 1) + ' .nv-point').attr("fill", "#666666").attr('stroke', '#666');
                ...
                for (var i = 0; i < 2; i++) {
                    if ((con[j][i].x === e.point.x) && (con[j][i].y === e.point.y)) {
                        ...
                        for (var k = 0; k < con[j].length; k++) {
                            ...
                            $('#main_chart .nv-scatterWrap .nv-groups .nv-series-' + (con[j][k].y - 1) + ' .nv-point-' + point).attr("fill", "#666666").attr('stroke', '#666');
                        }
                    }
                }
            }
            point = timestamps.indexOf(e.point.x);
            $('#main_chart .nv-scatterWrap .nv-groups .nv-series-' + (e.point.y - 1) + ' .nv-point-' + point).attr("fill", "#000000");
        }
        else {
            $('.nvtooltip').html('');
        }
    ...
    chart.lines.dispatch.on('elementMouseout', function () {
        ...
        $('#main_chart .nv-lineChart circle.nv-point').attr("fill", "#a90f0a");
    });

    setTimeout(function () {
        var text = $('#main_choice').text();
        $('#main_chart .nv-x .tick text').attr("transform", 'translate(0,' + -($('#main_chart').height() + 30) + ')rotate(45 0 0)');
        for (var i = 0; i < cumlen; i++) {
            for (var j = 0; j < timelen; j++) {
                if (text.substr(21) === "Users") {
                    var cent = users[i][j];
