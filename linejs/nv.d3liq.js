...
// main function to use when adding a new graph, see examples
    ...
    (function () {
        ...
        nv.tooltip.calcTooltipPosition = function (pos, gravity, dist, container) {
            ...
            if (container.parentElement.id === "main_chart") {
                ...
                setTimeout(function () {
                    if (mousey + $('.nvtooltip').height() + 100 > windowHeight) {
                        if ($('.nvtooltip').height() > windowHeight) {
                            $('.nvtooltip').css({'zoom': '0.8', '-moz-transform:': 'scale(0.8)'})
                        }
                        top = mousey - $('.nvtooltip').height() - 100;
                        $('.nvtooltip').css({'top': 'auto', 'bottom': '20px'});
                    }

                }, 550);

//        var height2=(windowHeight)+200;
//        var tah=200;
//        top=top-50;
//if((left+800)>windowWidth){left=left-((left+800)-windowWidth)-200;}
//if((top+900+tah)>height2){top=top-((top+900+tah)-height2);}
            }
                ...
                switch (axis.orient()) {
                    ...
                    case 'bottom':
                        ...
                        if (staggerLabels)
                            xTicks
                                .attr('transform', function (d, i) {
                                    return 'translate(0,' + nv.utils.NaNtoZero((i % 2 == 0 ? '0' : '12')) + ')'
                                });
